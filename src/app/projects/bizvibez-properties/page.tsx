...
const projectData = {
  ...
  details: [
      { title: `CRM`, description: `We integrated a comprehensive Customer Relationship Management system to streamline lead tracking, automate follow-ups, and ensure seamless communication between the sales team and potential clients.`, imageUrl: `/Projects/crm2.webp` },

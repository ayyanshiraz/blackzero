...
export const metadata: Metadata = {
  ...
  description: 'Discover how Black Zero helped Unique Studio showcase architectural excellence and generate high-quality leads in USA via targeted social media.',

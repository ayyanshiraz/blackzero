...
export const metadata: Metadata = {
  ...
  description: "Discover how Black Zero builds profitable ecommerce businesses from scratch. From niche hunting to global sourcing and scaling brands across the USA.",

...
export const metadata: Metadata = {
  ...
  description: `Looking for top digital marketing services in the USA? We provide expert growth strategies for small businesses to drive high-quality leads and ROI.`,
  keywords: [

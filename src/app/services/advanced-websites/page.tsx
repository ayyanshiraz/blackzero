...
export const metadata: Metadata = {
  ...
  description: `CustDiscover how Black Zero transforms your digital presence in the USA. Explore our custom web apps, scalable portals, 3D experiences, and Shopify development.`,

...
const ProjectCard = ({ project }: { project: any }) => (
    <div className={`group relative block w-full h-full overflow-hidden rounded-xl shadow-lg cursor-pointer ${project.className}`}>
        <img
            src={project.imageUrl}
            alt={project.imgAltText || project.title} // Use the SEO alt text

...
export default function EcommerceSuccessClient() {
    const heroBackgroundStyle = {
        backgroundColor: '#000000',
        backgroundImage: `url('/es.webp')`, 
        backgroundSize: 'cover',
        backgroundPosition: 'center',
    };

    const successStepsData = [
        { number: '01', title: 'NICHE & PRODUCT HUNTING', description: "We are here to help you find the problem-solving, game-changing evergreen products that sell regardless of the time and location. Count on us for the product hunt or niche finding we will make you proud of your decision." },
    ...
    return (
        <div className="bg-black text-white font-sans">
            ...
            <div style={heroBackgroundStyle} className="relative min-h-screen w-full flex items-center overflow-hidden">
                ...
                <div className="container mx-auto px-10 md:px-28 h-full flex items-center relative z-20">
                    <div className="md:w-1/3 text-center md:text-left">
                        <p className="text-2xl md:text-3xl font-light mb-4">The Time Proven Recipe For Effortless</p>
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-extrabold uppercase tracking-tighter leading-none">
                            Ecommerce Success!
                        </h1>
            ...
            <section className="bg-black text-white py-20">
                <div className="container mx-auto px-10 md:px-28">
                    <div className="text-center mb-20">
                        ...
                        <p className="mt-4 text-lg text-gray-400 max-w-3xl mx-auto">Working with our team allows you to save time and money by eliminating going through all the standard business procedures. We will take care of everything from the research and launch of your product, website, branding, IT and Marketing.</p>
                    </div>

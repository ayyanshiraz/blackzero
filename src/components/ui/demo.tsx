...
export function SplineSceneBasic() {
  ...
  return (
    <Card className="w-full h-full bg-transparent relative overflow-hidden border-none rounded-none flex flex-col">
      <div className="flex flex-col md:flex-row flex-1 w-full max-w-[1920px] mx-auto h-full">
        
        {/* Left content (Text) */}
        {/* Increased desktop top padding with md:pt-48, lg:pt-64, and xl:pt-72 */}
        <div className="w-full h-[60%] md:h-full md:flex-1 p-6 pt-28 md:pt-48 lg:pt-64 xl:pt-37 md:pl-16 lg:pl-24 relative z-10 flex flex-col justify-start pointer-events-none order-1">
        ...
        {/* Mobile: exactly 40% height. Absolute inset-0 added to prevent canvas layout breaking. */}
        <div className="w-full h-[40%] md:h-full relative md:flex-1 pointer-events-auto order-2 overflow-hidden flex items-center justify-center">

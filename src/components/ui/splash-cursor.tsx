...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Force TypeScript to treat gl as non-null to prevent closure errors
...
function generateColor(): ColorRGB {
      // Generate a random brightness value between 0.05 and 0.2 
      // keeping the effect subtle so it doesn't wash out the screen.
      const brightness = Math.random() * 0.15 + 0.05; 
      
      // By assigning the exact same value to r, g, and b, 
      // we guarantee a perfect grayscale color.
      return { 
        r: brightness, 
        g: brightness, 
        b: brightness 

    ...
    return (
        <div className="bg-black text-white font-sans">
            ...
            <section
                ...
                style={{ backgroundImage: "url('/contact4.webp')" }}
            >
                <div className="absolute inset-0 bg-black/60 z-10 backdrop-filter backdrop-blur-[2px]"></div>

                <div className="relative z-20 container mx-auto px-6 sm:px-12 md:px-32">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-12 text-center md:text-left">

                        <div className="md:w-1/2">
                            <h1 className={`text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter leading-none ${isHeroVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
                                CONTACT<br />US!
                            </h1>
                            <p className={`text-lg sm:text-xl md:text-2xl mt-4 max-w-md mx-auto md:mx-0 text-gray-200 ${isHeroVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
                                Have a query? Do not hesitate to reach out. We would love to hear from you!
                            </p>
                        </div>

                        <div className="md:w-1/2 md:pl-16">
                            <div className={`w-full ${isHeroVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'opacity 0.5s ease-in 0.8s' }}>
                                <p className="text-xl sm:text-2xl md:text-3xl font-light h-20 md:h-auto">
                                ...
                                {isRegularPartComplete && (
                                    <p className="text-base sm:text-lg md:text-xl text-gray-200 mt-2 max-w-md mx-auto md:mx-0">
            ...
            <section style={formSectionBackgroundStyle} className="py-20">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-300 text-lg">Have a project in mind? We would love to hear about it.</p>
                    </div>
